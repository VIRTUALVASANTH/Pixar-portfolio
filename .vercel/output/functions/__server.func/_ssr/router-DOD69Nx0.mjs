...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DOD69Nx0.js
var router_DOD69Nx0_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-Dxfox7am.css";
var APP_NAME = "Vasanth's World";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "An immersive Pixar-style room. Every room tells a story."
			},
			{
				name: "theme-color",
				content: "#140e0b"
...
var $$splitComponentImporter = () => import("./routes-DCVEtJCA.mjs").then((n) => n.t);
...
//#endregion
export { getRouter, router_DOD69Nx0_exports as t };
